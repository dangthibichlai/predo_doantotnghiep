...
class _BoardState extends ConsumerState<Board> {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      boardProv.board.displacementX = box.localToGlobal(Offset.zero).dx + 20; //- margin
      boardProv.board.displacementY = box.localToGlobal(Offset.zero).dy - statusBarHeight + 20; // statusbar
    });
    return Listener(
      onPointerUp: (event) {
