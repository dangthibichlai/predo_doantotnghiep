            ...
            return Obx(
              () => ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final listMember = controller.listMembers.value as List<AuthModel>;
                  return Column(
                    children: [
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              child: ClipOval(
                                child: AppImage(
                                  user.getUser(item.userId ?? '', listMember).avatar ?? ImagesPath.logoApp,
                                  width: 30.sp,
                                  height: 30.sp,
                                ),
                              ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        user.getUser(item.userId ?? '', listMember).full_name ?? '',
